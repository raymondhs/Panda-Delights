...
if sys.argv[1] == "sample":
    ...
    project_data.to_csv('../data/sample/projectids.txt', header=None, index=False)
...
if sys.argv[1] == "train":
    ...
    project_data.to_csv('../data/filtered-train/projectids.txt', header=None, index=False)

if sys.argv[1] == "test":
    project_idx = \
        np.where(projects_arr[:,-1] >= '2014-01-01')[0]
    project_data = pd.DataFrame(projects_arr[project_idx,0])
    project_data.to_csv('../data/test/projectids.txt', header=None, index=False)
